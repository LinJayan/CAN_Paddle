...
def manual_join():
    f_rev = open("../dataset/reviews-info", "r")
    user_map = {}
    item_list = []
    for line in f_rev:
        line = line.strip()
    ...
    f_meta = open("../dataset/item-info", "r")
    meta_map = {}
    for line in f_meta:
...
def split_test():
    fi = open("../dataset/jointed-new", "r")
    fo = open("../dataset/jointed-new-split-info", "w")
    user_count = {}
    for line in fi:
        line = line.strip()
        user = line.split("\t")[1]
