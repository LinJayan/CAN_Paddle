...
fin = open("../dataset/jointed-new-split-info", "r")
ftrain = open("../dataset/local_train", "w")
ftest = open("../dataset/local_test", "w")
...
for line in fin:
    ...
    if user != last_user:
        movie_id_list = []
        cate1_list = []
        # print(items[1] + "\t" + user + "\t" + movie_id + "\t" + cat1 +"\t" + "" + "\t" + "", file=fo)
    else:
